...
#
cetak(panel(f'''
{m}  ____    _    ____    _    ____  ___ 
{m} | __ )  / \  / ___|  / \  |  _ \|_ _|
{m} |  _ \ / _ \ \___ \ / _ \ | |_) || | 
{x} | |_) / ___ \ ___) / ___ \|  _ < | | 
{x} |____/_/   \_\____/_/   \_\_| \_\___|
  ''',style=f'{bas_wrn}',title=f''))
#
cetak(panel(f'''{x}1. crack publik massal
{x}2. crack dari followers
{x}3. crack dari grup fb
{x}4. chek hasil crack
{x}5. keluar hapus coki''',title=f'[cyan] menu',style=f'{bas_wrn}'))
